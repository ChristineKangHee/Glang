...
class levelTestmcqQuiz extends StatefulWidget {
  final LevelTestMcqQuestion question; // 퀴즈 문제 객체
  final Function(int) onAnswerSelected; // 사용자가 선택한 답안 인덱스를 처리하는 콜백 함수
  final int? userAnswer; // 이전 답안을 표시하기 위한 선택적 매개변수

  levelTestmcqQuiz({required this.question, required this.onAnswerSelected, this.userAnswer});

  @override
  _levelTestmcqQuizState createState() => _levelTestmcqQuizState();
}

class _levelTestmcqQuizState extends State<levelTestmcqQuiz> {
